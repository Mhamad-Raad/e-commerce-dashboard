          ...
          <tbody className="divide-y divide-slate-100">
            ...
            {data?.items.map((order) => (
              <tr key={order.id} className="hover:bg-slate-50">
                <td className="px-4 py-3 font-mono text-xs text-slate-700">{order.number}</td>
                ...
                <td className="px-4 py-3 text-slate-500">{formatDate(order.placedAt)}</td>
                <td className="px-4 py-3 text-right">
                  <Link to={`/orders/${order.id}`} className="text-slate-700 hover:underline">
                    Open
                  </Link>
                </td>
              </tr>
